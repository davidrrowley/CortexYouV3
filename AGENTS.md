...
This file defines the available agent IDs (for example `app-python`, `frontend-carbon`, `terraform-iac`) plus the full contract for each agent (display name, stream, mission, tooling, guardrails, cost profile).
