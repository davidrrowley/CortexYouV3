...
| .agents/providers/claude/sub.agents/architect.md | Claude subagent prompt. |
| .agents/providers/claude/sub.agents/orchestrator-pgm.md | Claude subagent prompt. |
...
| origin/.agents/providers/claude/sub.agents/architect.md | Baseline snapshot of: Claude subagent prompt. |
| origin/.agents/providers/claude/sub.agents/orchestrator-pgm.md | Baseline snapshot of: Claude subagent prompt. |
